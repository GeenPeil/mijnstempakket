              ...
              <?php if($_GET['created']=='yes'): ?>
                <div class="social">
                  <div style="text-align: center;" >
                    ...
                    <a style="margin-left: 10px;" href="https://twitter.com/intent/tweet/?hashtags=GeenPeil,MijnStemPakket&url=<?=urlencode("https://mijnstempakket.geenpeil.nl/resultaat.php".$checkedURI)?>&text=Zo%20ziet%20mijn%20stempakket%20eruit." target="_blank" id="soc_tw"><img src="icon-twitter.png" alt="Deel jouw stempakket op Twitter!" width="64" height="64" /></a>
                  </div>
                </div>
